...
namespace Data.DumbData
{
    public class Storage
    {
        ...
        public static List<User> UserCollection = new List<User>() 
        {
            ...
            new User {Id=4, Login="aaaa",Password=GetMd5Hash("123"),PersonalInfo = PersonalInfoCollection[4], Role = RoleCollection[4]},
            new User {Id=5, Login="sssss",Password=GetMd5Hash("123"),PersonalInfo = PersonalInfoCollection[5], Role = RoleCollection[5]},
